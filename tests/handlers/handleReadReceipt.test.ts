...
import { clearTransfer, isTransferComplete } from "../../src/handlers/reconcile";

import type { BaseQueryApi } from "@reduxjs/toolkit/query";
import type { Room } from "../../src/reducers/roomSlice";
...
let handleReadReceipt: (typeof import("../../src/handlers/handleReadReceipt"))["handleReadReceipt"];

beforeAll(async () => {
  await import("../../src/store");
  ({ handleReadReceipt } = await import("../../src/handlers/handleReadReceipt"));
});
